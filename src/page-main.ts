...
export default function pageMain(): {
  innerObject: Omit<InnerObjectType, "longText" | "makeTodaysDate">;
} {
  const innerObject: Omit<InnerObjectType, "longText" | "makeTodaysDate"> = {
    init(): void {
      this.createHeader();
      this.createMain();
      this.createFooter();
    ...
    createFooter(): void {
      ...
      this.a = this.manipulateDOM(
        "a",
        "stein egil liland",
        "",
        ".fLi1",
        "href",
        "https://www.pexels.com/photo/abandoned-wooden-barn-on-grassy-terrain-against-starry-night-sky-5740848/",
        "target",
        "_blank"
      );
      ...
      this.a = this.manipulateDOM(
        ...
        ".fLi2",
        "href",
        "https://www.pexels.com/photo/wooden-interior-of-modern-restaurant-in-marine-style-4344544/",
        "target",
        "_blank"
      );
      ...
      this.a = this.manipulateDOM(
        ...
        ".fLi3",
        "href",
        "https://www.pexels.com/photo/a-person-cooking-in-a-pan-outdoors-13739759/",
        "target",
        "_blank"
      );
      ...
      this.a = this.manipulateDOM(
        ...
        ".fLi5",
        "href",
        "https://www.pexels.com/photo/close-up-photograph-of-fish-heads-near-tomatoes-11244934/",
        "target",
        "_blank"
      );
      ...
      this.a = this.manipulateDOM(
        ...
        ".fLi7",
        "href",
        "https://www.flaticon.com/free-icon/fish-bone_4201633?term=fish%20bones&page=1&position=1&page=1&position=1&related_id=4201633&origin=style",
        "target",
        "_blank"
      );
      ...
      this.a = this.manipulateDOM(
        ...
        ".fLi9",
        "href",
        "https://unsplash.com/photos/dIbPZcftpL8",
        "target",
        "_blank"
      );
      ...
      this.a = this.manipulateDOM(
        ...
        ".fLi11",
        "href",
        "https://www.pexels.com/photo/delicious-appetizer-with-boiled-lobster-and-wine-4553378/",
        "target",
        "_blank"
      );
      ...
      this.a = this.manipulateDOM(
        ...
        ".fLi13",
        "href",
        "https://unsplash.com/photos/q8-yKQ3P7J0",
        "target",
        "_blank"
      );
    },
