export default function pageReserve() {
    ...
    const innerObject = {
        ...
        createMain: function() {            
            ...
            // You need to add this code and link it to the "min" attribute of your
            // date input of the html so that it won't give you the option of
            // picking dates prior to today.
